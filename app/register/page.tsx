...
export default function RegisterPage() {
  return (
    <div className="relative flex min-h-screen flex-1 items-center justify-center overflow-hidden bg-slate-950 px-4 py-12">
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(99,102,241,0.35),transparent_45%),radial-gradient(circle_at_10%_10%,rgba(56,189,248,0.25),transparent_40%),radial-gradient(circle_at_50%_100%,rgba(168,85,247,0.25),transparent_45%)]"
      />
      <div
        aria-hidden
